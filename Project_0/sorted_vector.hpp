...
//copy constructor, copies all values of a given vector and gives a new vector the same values.
template <typename T>
...
//move constructor, allows you to create a new vector and give it the address of another vector
//the other vector then points to nothing.
template <typename T>
...
//iterator constructor, allows you to create a new vector and give it the .begin and .end of another vector
//the new vector will be filled with the other vectors contents, iteratively.
template <typename T>
...
//give a pointer to an element in the vector you would like erased.
template <typename T>
